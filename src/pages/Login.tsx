...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("userEmail", data.email || emailNorm);
      toast({ title: "Login Successful", description: `Welcome back!` });
      navigate(data.role === "staff" ? "/staff" : "/chat");
    } catch (err: any) {
      toast({ title: "Login error", description: err?.message || "Unable to reach server.", variant: "destructive" });
    }
  };
